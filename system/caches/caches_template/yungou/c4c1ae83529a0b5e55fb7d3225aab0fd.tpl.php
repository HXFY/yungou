...
<div class="goods_hot">
	<div class="goods_left">
		...
		<div class="new_lottery">
			...
			<a href="<?php echo WEB_PATH; ?>/dataserver/<?php echo $qishu['id']; ?>" target="_blank" class="name"><?php echo $qishu['title']; ?></a> 
		  	<span class="winner">获得者：<strong><a rel="nofollow" class="blue" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($qishu['q_uid']); ?>" target="_blank"><?php echo _strcut(get_user_name($qishu['q_user']),15); ?></a></strong></span>
			</li>
			<?php  endforeach; $ln++; unset($ln); ?>
			</ul>
            <!------>
	...
	<div class="goods_right">
		...
		<a href="<?php echo G_WEB_PATH; ?>/goods/17005" target="_blank"><img src="<?php echo G_UPLOAD_PATH; ?>/banner/20130510162727797.jpg" width="230" height="200"></a>
		</div>
    ...
    <div class="share_show">
        ...
        <div class="show">
			...
			<dl>
				...
				<dd class="bg">
					<ul>
						<li class="name"><span><a href="<?php echo WEB_PATH; ?>/go/shaidan/detail/<?php echo $sd['sd_id']; ?>" target="_blank"><?php echo $sd['sd_title']; ?></a></span> 获得者：<a rel="nofollow" class="blue" href="<?php echo WEB_PATH; ?>/uname/<?php echo $sd['sd_userid']; ?>" target="_blank"><?php echo _strcut(get_user_name($sd['sd_userid']),16); ?></a></li>
						<li class="content"><?php echo $sd['sd_content']; ?></li>
			...
			<div class="show_list">	
				...
				<ul>
					...
					<li>获得者：<a rel="nofollow" class="blue" href="<?php echo WEB_PATH; ?>/uname/<?php echo $sd['sd_userid']; ?>" target="_blank"><?php echo _strcut(get_user_name($sd['sd_userid']),15); ?></a></li>
