...
<link rel="stylesheet" type="text/css" href="<?php echo G_TEMPLATES_CSS; ?>/ygRecord.css">
   <input name="hidBuyId" type="hidden" id="hidBuyId" value="1948496">
    ...
    <div class="ygRecord">
        <h3>
            <span>最新云购记录</span><p>本页显示最新云购记录<strong>100</strong>条 <a href="<?php echo WEB_PATH; ?>/buyrecord">查看历史云购记录&gt;&gt;</a></p>
        </h3>
        <ul class="Record_title">
            <li class="time">云购时间</li>
            <li class="nem">会员账号</li>
            <li class="name">云购商品名称</li>
            <li class="much">云购人次<!--云购人次--></li>
        </ul>
        <div id="recordList">
                <?php $n=1; ?>    
        ...
        <div class="endpage">本页显示最新云购记录<strong>100</strong>条 <a href="<?php echo WEB_PATH; ?>/buyrecord" rel="nofollow">查看历史云购记录&gt;&gt;</a></div>
    </div>
