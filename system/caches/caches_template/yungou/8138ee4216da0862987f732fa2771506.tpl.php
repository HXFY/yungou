<?php defined('G_IN_SYSTEM')or exit('No permission resources.'); ?><div class="footer_content">
   		...
   		<div class="support">
            ...
            <?php if(defined('G_IN_ADMIN')) {echo '<div style="padding:8px;background-color:#F93; color:#fff;border:1px solid #f60;text-align:center"><b>This Tag</b></div>';}?>
   			...
   			<dl class="ft-fwrx">
   				...
   				<dd class="ft-fwrx-time">周一至周五18:30-23:00 周六日全天</dd>  
   	...
   	<div class="service-promise">
   		<ul>
   			...
   			<li class="sp-free-delivery"><a href="<?php echo WEB_PATH; ?>/help/7" target="_blank"><span>工大免费配送</span></a></li>
   			<li class="sp-business service-promise-border-r0"><a href="<?php echo WEB_PATH; ?>/single/business" target="_blank"><span>商务合作15212783083</span></a></li>
   		</ul>
   	</div>
...
<div class="footer" style="height:auto;">
	...
	<div class="footer_icon" style="width:499px;">
		<ul>
			<li class="fi_ectrustchina"></li>
			<li class="fi_315online"></li>
			<li class="fi_cnnic"></li>
  			<li class="fi_anxibao"></li>
			<li class="fi_pingan"></li>
		</ul>
	</div>
</div>
<script>
...
<!--footer end-->
			...
			<div class="weix"  >
				<a href="javascript:void(0);" id="close" class="fixed_wx_close"></a>
   				...
   				<dd class="gray02" align="center">关注微博~</dd>
			</div>
